        ...
        <div class="w-full flex flex-col h-screen overflow-y-hidden">
                ...
                <div class="flex flex-wrap -mx-6">
                    <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                            ...
                            <div class="mx-5">
                                ...
                                <div class="text-gray-500">参加メンバー</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700">7.7</h4>
                                <div class="text-gray-500">グループ内の平均値</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700">6.9</h4>
                                <div class="text-gray-500">全体平均値</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full overflow-x-hidden border-t flex flex-col">
                <main class="w-full flex-grow px-14">
                            ...
                            <table class="min-w-full bg-white">
                                <thead class="bg-gray-800 text-white">
                                    <tr>
                                        ...
                                        <th class="text-left py-3 px-4 uppercase font-semibold text-sm">残り回数
                                        </th>
                                ...
                                <tbody class="text-gray-700">
                                    <tr>
                                        ...
                                        <td class="text-left py-3 px-4"><a class="hover:text-blue-500"
                                                href="tel:622322662">3.5</a></td>
                                        <td class="text-left py-3 px-4">1</td>
                                        <td class="text-left py-3 px-4">受講前記入済み</td>
                                        <td class="text-left py-3 px-4"><a class="hover:text-blue-500"
                                                href="#">詳細画面</a>
                                    </tr>
                                    <tr>
                    ...
                    <footer class="w-full bg-white text-right p-4 text-sm">
                        株式会社OnLine</a>.
                    </footer>
            </div>
        </div>
